...
const blocksData = [
{ id: "1", tex: "Considere \\(\\frac{x}{y}\\)." },
{ id: "2", tex: "Temos \\(\\frac{x}{y} = \\frac{b^a}{b^c}\\)." },
{ id: "3", tex: "Logo, \\(\\frac{x}{y} = b^{a-c}\\)." },
{ id: "4", tex: "Aplicando logaritmo: \\(\\log_b\\!\\left(\\frac{x}{y}\\right) = \\log_b(b^{a-c})\\)." },
{ id: "5", tex: "Pela definição, \\(\\log_b(b^{a-c}) = a - c\\)." },
{ id: "6", tex: "Portanto, \\(\\log_b\\!\\left(\\frac{x}{y}\\right) = a - c\\)." }
];
