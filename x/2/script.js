document.addEventListener("DOMContentLoaded", () => {
  ...
  const blocksData = [
    { id: "1", tex: "\\( \\text{Cada par tem a forma } (a_1 + a_n) \\)" },
    { id: "2", tex: "\\( \\text{Todos os pares têm a mesma soma} \\)" },
    { id: "3", tex: "\\( \\text{Existem } n \\text{ termos} \\)" },
    { id: "4", tex: "\\( \\text{Logo há } n \\text{ parcelas iguais} \\)" },
    { id: "5", tex: "\\( 2S_n = n(a_1 + a_n) \\)" },
    { id: "6", tex: "\\( S_n = \\frac{n}{2}(a_1 + a_n) \\)" }
  ];
