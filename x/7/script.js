...
const blocksData = [
  { id: "1", tex: "Aplicando \\(\\log_a\\) em ambos os lados:" },
  { id: "2", tex: "\\(\\log_a(b^y) = \\log_a(x)\\)" },
  { id: "3", tex: "Pela propriedade da potência:" },
  { id: "4", tex: "\\(y \\cdot \\log_a(b) = \\log_a(x)\\)" },
  { id: "5", tex: "Dividindo por \\(\\log_a(b)\\):" },
  { id: "6", tex: "\\(y = \\frac{\\log_a(x)}{\\log_a(b)}\\)" }
];
