...
const blocksData = [
{ id: "1", tex: "Aplicando logaritmo na base \\(a\\): \\(\\log_a(b^y) = \\log_a(x)\\)." },
{ id: "2", tex: "Pela propriedade da potência: \\(y \\cdot \\log_a(b) = \\log_a(x)\\)." },
{ id: "3", tex: "Isolando \\(y\\): \\(y = \\frac{\\log_a(x)}{\\log_a(b)}\\)." },
{ id: "4", tex: "Mas \\(y = \\log_b(x)\\)." },
{ id: "5", tex: "Substituindo: \\(\\log_b(x) = \\frac{\\log_a(x)}{\\log_a(b)}\\)." },
{ id: "6", tex: "Portanto, a mudança de base está demonstrada." }
];
