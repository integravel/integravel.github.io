document.addEventListener("DOMContentLoaded", () => {
  ...
  const blocksData = [
    { id: "1", tex: "\\( \\text{Os termos intermediários se cancelam} \\)" },
    { id: "2", tex: "\\( qS_n - S_n = a_1q^n - a_1 \\)" },
    { id: "3", tex: "\\( S_n(q - 1) = a_1(q^n - 1) \\)" },
    { id: "4", tex: "\\( \\text{Fatorando ambos os lados} \\)" },
    { id: "5", tex: "\\( \\text{Isolando } S_n \\)" },
    { id: "6", tex: "\\( S_n = \\frac{a_1(q^n - 1)}{q - 1} \\)" }
  ];
