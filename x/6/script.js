...
const blocksData = [
{ id: "1", tex: "Considere \\(x^k\\)." },
{ id: "2", tex: "Temos \\(x^k = (b^a)^k\\)." },
{ id: "3", tex: "Logo, \\(x^k = b^{ak}\\)." },
{ id: "4", tex: "Aplicando logaritmo: \\(\\log_b(x^k) = \\log_b(b^{ak})\\)." },
{ id: "5", tex: "Pela definição, \\(\\log_b(b^{ak}) = ak\\)." },
{ id: "6", tex: "Portanto, \\(\\log_b(x^k) = ak\\)." }
];
